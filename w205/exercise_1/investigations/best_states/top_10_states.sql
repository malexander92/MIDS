...
SELECT
	...
	CASE WHEN measure_id LIKE 'READM%' THEN 'readmission_average'
		...
		AS measure_group,
	SUM(number_hospitals_better) AS number_hospitals_better,
	SUM(number_hospitals_worse) AS number_hospitals_worse,
	SUM(number_hospitals_better) - SUM(number_hospitals_worse) AS net_hospitals
